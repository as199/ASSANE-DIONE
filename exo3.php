       ...
       include'fonctions.php';
        ...
        if (isset($_POST['calcul'])) {
            ...
            if (verifnombre($_POST['nb'])) {
                ...
                $_SESSION['error']="Veuillez entrer une bonne valeur ";
            }
        }
            ...
            for ($i=1; $i <=$_SESSION['val'] ; $i++) { 
                ...
                if (verifmot($_POST[$p])) {
                    ...
                    if (verifcompteur($_POST[$p],$y)) {
                        ...
                        $indice="m".$i;
                        $_SESSION[$indice]=" le mot dépasse 20 caractére ";
                        $verif_bon++;
                    }
                }else{
                    $indice="m".$i;
                    $_SESSION[$indice]=" entrez un mot composer par des lettres";
                    $verif_bon++;
                }
            }
